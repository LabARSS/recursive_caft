"""Training configuration for Branch C: Q + options + prev_answer + gold -> error analysis"""
...
if __name__ == "__main__":
    train_sft_by_complexity_split(
        out_path=str(Path(__file__).parent / "../../../../data/out/models/branch_c"),
        model_id="Qwen/Qwen2.5-3B-Instruct",
        train_df_path=str(Path(__file__).parent / "../../../../data/out/sft_data/branch_c_train.parquet"),
